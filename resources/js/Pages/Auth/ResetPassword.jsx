        ...
        <GuestLayout>
            <div className="space-y-6">
                <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center">
                    <h1 className="text-2xl font-extrabold text-white">رمز جدید بساز</h1>
                    <p className="mt-2 text-sm text-slate-400">یه رمز قوی انتخاب کن؛ ترکیبی از حرف و عدد و علامت 💪</p>
                </motion.div>

                <form onSubmit={submit} className="space-y-4" noValidate>
                    <div>
                        <label htmlFor="password" className="mb-2 block text-sm font-medium text-slate-300">رمز عبور جدید</label>
                    ...
                    <div>
                        <label htmlFor="password_confirmation" className="mb-2 block text-sm font-medium text-slate-300">تکرار رمز جدید</label>
                        <input
